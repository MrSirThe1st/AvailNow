...
const WidgetPreview = ({ settings, userId }) => {
  ...
  // Simulate a basic business website
  const MockWebsite = () => (
    <div className="min-h-full bg-white text-gray-800 font-sans">
      {/* Navbar */}
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              ...
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl">
                We provide top-notch services to help your business grow and
                succeed. Book an appointment today to learn more about our
                offerings.
              </p>
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2025 Business Name, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
  ...
  // Fullscreen preview with mock website
  ...
  return isFullscreen ? <FullscreenPreview /> : <RegularPreview />;
};
